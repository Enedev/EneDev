...
| **Game Dev (Hobby)** | <img src="https://img.shields.io/badge/Unity-FFFFFF?style=flat&logo=unity&logoColor=black" height="25"/> &nbsp; <img src="https://img.shields.io/badge/Godot-478CBF?style=flat&logo=godot-engine&logoColor=white" height="25"/> |
...
### 📚 Learning Path
*Technologies and concepts I am currently exploring to advance my professional expertise:*

* 🛍️ **Shopify**: Currently starting my journey in the Shopify ecosystem, learning the fundamentals of theme development and Liquid.
* ⚛️ **React Ecosystem**: Deepening my knowledge in advanced **State Management** and specialized **Libraries** to build more robust and scalable applications.
* ⚡ **Modern Tooling (Vite)**: Implementing faster build pipelines and optimizing development workflows.
* 🤖 **AI-Driven Optimization**: Researching how to leverage AI to enhance code efficiency and automate repetitive tasks.

---

### 🎮 Beyond the Web: Game Dev as a Hobby
When I'm not architecting web solutions, I dive into **Unity** and **Godot**. For me, game development is a creative hobby where I experiment with:
* 🕹️ **Logic & Mechanics**: Building interactive systems just for the fun of it.
* 🧪 **Rapid Prototyping**: Exploring new ideas and physics-based challenges.
* 🎨 **Creative Problem Solving**: Applying my coding skills to digital storytelling and world-building.

---

### 📫 Connect with me
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/neithan-gomez-65422235b/)
[![Portfolio (Currently working on!)](https://img.shields.io/badge/Portfolio-FF5722?style=for-the-badge&logo=todoist&logoColor=white)](YOUR_PORTFOLIO_URL)
